...
function getEndpoints(deviceAddress, endpoints) {
  ...
  var e = endpoints.addEndpoint("2", "Nivel del líquido", endpointType.genericSensor);
  e.variableTypeId = 1383;

  var e = endpoints.addEndpoint("3", "Volumen del líquido", endpointType.genericSensor);
  e.variableTypeId = 1384;

  var e = endpoints.addEndpoint("4", "Flujo volumétrico", endpointType.genericFlowSensor);
